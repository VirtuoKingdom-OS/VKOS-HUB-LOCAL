...
> Execute o plano da pasta docs/planos/mapa-telas
...
- `interno/mapa-sistema.json` e `docs/contexto/arquitetura.md` atualizados na mesma tarefa (o Mapa ganha responsabilidade nova).
