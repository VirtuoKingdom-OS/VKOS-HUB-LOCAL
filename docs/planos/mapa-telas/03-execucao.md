...
- [ ] `docs/contexto/arquitetura.md`: seção do Mapa ganha um parágrafo sobre a visão Telas.
- [ ] `app/CONTRATO.md`: registro da rodada com data.
- [ ] `docs/decisoes/`: registrar a decisão (dado em `interno/`, navegação por hash, sem screenshot) quando o Jesse aprovar o plano.
