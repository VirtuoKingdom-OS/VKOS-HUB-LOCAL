...
Este arquivo existe pra decisão consciente. O Jesse pesquisou o tema na rodada 16 (ver docs/contexto/fase7-meta-plano.md pro caminho oficial); aqui fica o retrato honesto do caminho local.
...
- O plano B documentado continua de pé: a API oficial da Meta (docs/contexto/fase7-meta-plano.md), sem risco de ban, com custo por conversa fora da janela de 24h e webhook via túnel. A arquitetura deste plano isola o transporte justamente pra essa troca não reescrever a caixa nem os agentes.
