...
- Barramento de eventos: especificado na peça 1 de `docs/planos/google-calendar/02-arquitetura.md`. Se ainda não existir quando este plano rodar, é construído primeiro, idêntico.
