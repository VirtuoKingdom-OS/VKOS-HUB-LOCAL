...
> Missão: registrar no fim da rodada: decisão em docs/decisoes/ (agentes de atendimento, modos e guardrails), atualização de docs/contexto/arquitetura.md e roadmap.md, e um custo estimado honesto por resposta de agente medido nas sessões de teste da rodada (o gerenciador já contabiliza), escrito na tela de Agentes (rodapé discreto "custo aproximado por resposta").
