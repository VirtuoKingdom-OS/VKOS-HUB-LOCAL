...
- **Biblioteca não oficial de WhatsApp.** Banimento permanente do número de trabalho. Ver `docs/decisoes/2026-07-27-whatsapp-api-oficial-e-coexistence.md`.
...
O quadro vivo está em `02-estado.md`. As decisões de WhatsApp estão em `docs/decisoes/2026-07-27-*`. Os relatórios completos das quatro auditorias não foram salvos em disco: o que sobreviveu deles está resumido aqui e no `03-checkup-2026-07-26.md`.
