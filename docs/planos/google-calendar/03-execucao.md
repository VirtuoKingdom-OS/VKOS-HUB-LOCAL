...
4. Registrar decisão em `docs/decisoes/AAAA-MM-DD-barramento-eventos-google-calendar.md` e atualizar `docs/contexto/arquitetura.md` e `docs/contexto/roadmap.md`.
...
6. Perguntar ao Jesse se pode apagar a pasta `docs/planos/google-calendar/`.
