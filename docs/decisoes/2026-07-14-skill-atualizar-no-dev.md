...
arquivos que a sessão lê aqui: `docs/contexto/` (visao, arquitetura, roadmap, ecossistema), `docs/decisoes/`,
`CLAUDE.md`, `app/CONTRATO.md` e a memória. A realidade a cruzar é o código em `app/`, não o Cérebro
de um cliente. A fonte da verdade de cada decisão é o arquivo em `docs/decisoes/`; roadmap e arquitetura
só apontam.
