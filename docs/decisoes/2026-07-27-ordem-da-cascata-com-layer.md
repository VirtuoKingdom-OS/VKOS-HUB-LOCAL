...
O `CLAUDE.md` e o `docs/contexto/arquitetura.md` diziam que `visual-hub.css` carrega por último e fixa o valor final de cada token por tema. Isso era verdade em `main.tsx` e mentira no build.
