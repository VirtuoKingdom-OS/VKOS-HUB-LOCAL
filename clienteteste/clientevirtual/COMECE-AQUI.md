...
Bem-vindo ao **VKOS**. Em uns 15 minutos seu sistema de marketing vai estar de pé. Você não
...
2. No VS Code, vá em **Arquivo → Abrir Pasta...** e escolha a pasta **vkos**.
3. Abra o Claude Code (o ícone dele na lateral, ou o atalho que a extensão mostra).

⚠️ **Importante:** abra a pasta **vkos** inteira — não um arquivo solto de dentro dela. É isso
...
"deu um erro", "não sei abrir a pasta") — ele responde em português simples e te desencalha.
