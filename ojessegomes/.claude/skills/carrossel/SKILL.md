...
`identidade/design-guide.md` (seção **Antes**, são as cores e a voz, não o catálogo), e a regra de
imagem-herói do Passo 4 (o próprio SKILL.md já diz quais modelos pedem imagem, sem precisar do
...
As imagens saem em `.../instagram/slide-01.png`, etc.
