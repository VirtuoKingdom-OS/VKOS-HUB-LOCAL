...
- O evento crm:contato-movido agora e disparado quando o CONTATO muda de coluna (antes era o negocio), com o mesmo payload (colunaDe, colunaPara, nomes). As automacoes de mudanca de estagio seguem funcionando sem tocar em nada. O resumo do CRM pra IA passou a contar contatos por coluna e somar o valor dos negocios daqueles contatos.
