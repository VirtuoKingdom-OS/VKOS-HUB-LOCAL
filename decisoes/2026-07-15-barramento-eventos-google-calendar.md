...
O Jesse pediu a conexão MCP com o Google Calendar, mas o pedido real era maior: um sistema onde o que acontece no hub dispara integrações externas (exemplo dele: o CRM move um cartão e o compromisso nasce na agenda). Plano completo escrito em planos/google-calendar/ e executado em 2026-07-15.
