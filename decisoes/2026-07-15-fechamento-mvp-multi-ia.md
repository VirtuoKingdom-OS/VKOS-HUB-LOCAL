...
5. O plano completo vive em `planos/fechamento-mvp/` (rodadas M1, M2, M3), escrito pra QUALQUER IA executar (caminhos relativos, pontos de verificação de CLI, modo sequencial pra executor sem agentes paralelos).
