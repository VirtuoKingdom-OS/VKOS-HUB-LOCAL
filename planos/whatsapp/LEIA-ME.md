...
> Execute o plano da pasta planos/whatsapp

(ou "Execute a rodada W2 do plano planos/whatsapp" pra continuar de onde parou; o executor confere o que já foi entregue antes de despachar.)
...
3. Conferir a dependência cruzada: se o plano `planos/google-calendar` ainda não executou, o barramento de eventos (peça 1 de lá) é construído AQUI primeiro, com a mesma especificação.
