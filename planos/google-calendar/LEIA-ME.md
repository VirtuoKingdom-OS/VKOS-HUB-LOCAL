...
> Execute o plano da pasta planos/google-calendar
...
4. Cumprir o checklist de fechamento (typecheck web e server, QA, rebuild do web/dist, registro em decisoes/ e contexto/).
