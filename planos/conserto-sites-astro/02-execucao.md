...
2. Atualizar `contexto/roadmap.md` na linha da rodada de 2026-07-17: acrescentar "validado em publicação real em AAAA-MM-DD" com o resultado.
3. Atualizar `app/CONTRATO.md` só se algo mudou de comportamento (mensagem de aviso, por exemplo).
4. Avisar o Jesse com o resumo honesto e perguntar se pode apagar as pastas `planos/sites-astro-e-design/` e `planos/conserto-sites-astro/`.
